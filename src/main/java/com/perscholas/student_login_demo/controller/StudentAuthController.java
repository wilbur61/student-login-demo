package com.perscholas.student_login_demo.controller;
...
public class StudentAuthController {
    ...
    public String registration(@Valid @ModelAttribute("student")
                               StudentDTO studentDto, BindingResult result,
                               Model model) {
        Student existingStudent =
                studentService.findStudentByEmail(studentDto.getEmail());
        if (existingStudent != null &&
                existingStudent.getEmail() != null
                && !existingStudent.getEmail().isEmpty()) {
